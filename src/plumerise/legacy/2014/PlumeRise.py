...
def plotAreaFRP(m,z_plume,imfile=None,Title=None):
    from matplotlib.pyplot import plot, legend, xlabel, ylabel, title, grid, figure
...
def plotPR(m,z_plume,imfile=None,Title=None):
    ...
    xlabel('GEOS-5 PBL Height [km]')
    ylabel('Plume Height [km]')
...
if __name__ == "__main__":
    ...
    m = MINXs_PR('/home/adasilva/workspace/misrPlumes/western_fires_2013/*.txt')
    m.sampleLoadz('/home/adasilva/workspace/Data_Analysis/AGU-2014/seac4rs_01.npz')
    m.mod14 = NPZ(('/home/adasilva/workspace/Data_Analysis/AGU-2014/mod14_seac4rs.npz',))
    z_plume = m.getPlume()
