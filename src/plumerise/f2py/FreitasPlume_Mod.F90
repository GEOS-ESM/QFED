...
Private
Public FreitasPlume
Public FreitasPlume_Initialize
Public FreitasPlume_Run
Public FreitasPlume_Finalize
...
end type FreitasPlume

interface FreitasPlume_Run
   module procedure FreitasPlume_Run_1d 
   module procedure FreitasPlume_Run_HF
   module procedure FreitasPlume_Run_VMD
end interface
...
subroutine FreitasPlume_Initialize ( This )
   use rconstants
   implicit none
#  include "FreitasPlume.h"   
 ...
 end subroutine FreitasPlume_Initialize
...
subroutine FreitasPlume_Run_1d ( this, km,     &
...
! Vertical levels n GEOS-5 are from top to bottom, while the FreitasPlume
...
end subroutine FreitasPlume_Run_1d

!..........................................................................

subroutine FreitasPlume_Run_HF ( this, km,     &
...
end subroutine FreitasPlume_Run_HF
...
#if 0
!ams -------------------------------------------------------------
 The call set_grid() has been moved to FreitasPlume_Initialize where
 it belongs.
...
!                       ---
   ...
   integer :: k, k_i, k_f, k_d, k_thresh=10
